(function($) {
    ...
    // Location Address
    //-------------------------------------------------------------------------------
    var companyName = 'Gem Suites';
    var address = 'Richmond, BC'; // Enter your Address
    ...
    var contentString = '<div id="content">' +
        ...
        'Located at City Center, Richmond, BC ' +
        '</div>';
    ...
    $('.show-inquiry-modal').on('click', function () {
        ...
        var richmond = 'https://www.airbnb.ca/rooms/9945647';
        var burnaby = 'https://www.airbnb.ca/rooms/13954972';
        var gemsuites = 'https://www.airbnb.ca/users/50954395/listings';
        if (object) {
            window.location = eval(object);
        }
    });
